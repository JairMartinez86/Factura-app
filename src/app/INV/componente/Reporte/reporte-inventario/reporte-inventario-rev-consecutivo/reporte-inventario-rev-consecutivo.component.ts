...
@Component({
  selector: 'app-reporte-inventario-rev-consecutivo',
  standalone: true,
  templateUrl: './reporte-inventario-rev-consecutivo.component.html',
  styleUrl: './reporte-inventario-rev-consecutivo.component.scss',
  imports: [ReporteInventarioFiltro3Component]
})
export class ReporteInventarioRevConsecutivoComponent {


  @ViewChild("Filtro", { static: false })
  public Filtro: ReporteInventarioFiltro3Component;
  ...
  public V_Imprimir(Exportar: boolean): void {
    document.getElementById("btnImprimir-Reporte-Inv-rev-consecutivo")?.setAttribute("disabled", "disabled");
    ...
    d.Param = [this.Filtro.val.Get("txtFecha1").value, this.Filtro.val.Get("txtFecha2").value, this.Filtro.val.Get("cmbSerie").value[0]]
    ...
    this.POST.Imprimir(d).subscribe(
      {
        ...
        error: (err) => {
          ...
          document.getElementById("btnImprimir-Reporte-Inv-rev-consecutivo")?.removeAttribute("disabled");
