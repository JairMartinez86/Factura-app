...
@Component({
  selector: 'app-reporte-inventario-venta-sucursal',
  standalone: true,
  imports: [ReporteInventarioFiltro2Component],
  templateUrl: './reporte-inventario-venta-sucursal.component.html',
  styleUrl: './reporte-inventario-venta-sucursal.component.scss'
})
export class ReporteInventarioVentaSucursalComponent {
  ...
  public V_Imprimir(Exportar: boolean): void {
    ...
    document.getElementById("btnImprimir-Reporte-Inv-ventas-por-sucursal")?.setAttribute("disabled", "disabled");
    ...
    d.Param = [this.Filtro.val.Get("txtFecha1").value, this.Filtro.val.Get("txtFecha2").value, this.Filtro.val.Get("cmbProducto1").value[0], this.Filtro.val.Get("cmbProducto2").value[0]]
    d.TipoReporte = "Ventas Por Sucursal";
    d.Exportar = Exportar;
    ...
    this.POST.Imprimir(d).subscribe(
      {
        ...
        error: (err) => {
          ...
          document.getElementById("btnImprimir-Reporte-Inv-ventas-por-sucursal")?.removeAttribute("disabled");
  ...
  private ngAfterViewInit() {
    ...
    this.Filtro?.val.addFocus("cmbProducto2", "btnImprimir-Reporte-Inv-ventas-por-sucursal", "click");
