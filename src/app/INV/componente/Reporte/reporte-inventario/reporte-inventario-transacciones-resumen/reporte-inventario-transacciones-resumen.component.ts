...
@Component({
    selector: 'app-reporte-inventario-transacciones-resumen',
    standalone: true,
    templateUrl: './reporte-inventario-transacciones-resumen.component.html',
    styleUrl: './reporte-inventario-transacciones-resumen.component.scss',
